		  ...
		  <h1>DEPT Detail PAGE!</h1>
			...
			<form action="dupdate.action" method="post">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="dname" name="dname" value="${bean.dname }" readonly="readonly"/>
				</div>
				<div class="form-group">
					<label for="loc">LOC</label>
					<input type="text" class="form-control" id="loc" name="loc" value="${bean.loc }"  readonly="readonly"/>
				</div>
				
			</form>
			<a href="dedit.action?deptno=${bean.deptno }"  class="btn btn-default" role="button">수 정</a>
			<a href="ddelete.action?deptno=${bean.deptno }" class="btn btn-danger" role="button">삭 제</a>
		</div>
